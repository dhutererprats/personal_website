document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.project-item-expandable .expandable-header').forEach(header => {
        header.addEventListener('click', () => {
          const container = header.closest('.project-item-expandable');
          container.classList.toggle('open');
        });
      });
    
      function toggleProject(element) {
        const parent = element.closest('.project-item.expandable');
